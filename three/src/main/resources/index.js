!function () {
    function e() {
        var e, t = this.$$;
        this.commands = linux_commands || [], this.elm_query = t("query"), this.elm_btn = t("search_btn"), this.elm_result = t("result"), this.elm_search_result = t("search_list_result"), this.root_path = (e = t("current_path"), t = window.location.origin + window.location.pathname, e ? t.replace(/\/(c\/)?(\w|-)+\.html/, "").replace(/\/$/, "") : ""), this.query = "", this.query_size = 5, this.page_size = 50, this.init(), this.goToIndex()
    }
    ...
    e.prototype = {
        $$: function (e) {
            ...
            e = new RegExp("(^|&)" + e + "=([^&]*)(&|$)", "i"), e = decodeURIComponent(window.location.hash.replace(/^(\#\!|\#)/, "")).match(e);
            ...
            i = this.root_path.replace(/\/$/, "");
            return this.simple(n ? '<a href="' + i + '/c$url$.html"><strong>$name$</strong> - $des$</a><p></p>' : '<a href="' + i + '/c$url$.html"><strong>$name$</strong> - $des$</a>', {
                name: s,
                url: e.p,
                des: r
            })
        }, searchResult: function (e) {
            var t = this.commands, n = this, s = 0, r = t.length, i = [], l = [],
                u = e ? this.page_size : this.query_size, a = [], o = [];
            if (t && t.length && -1 < toString.call(t).indexOf("Array")) for (; s < r && t[s]; s++) {
                var c, h = n.isSreachIndexOF(t[s].n, n.query), d = n.isSreachIndexOF(t[s].d, n.query);
                -1 < h ? ((c = t[s]).nIdx = h, a.push(c)) : -1 < d && ((c = t[s]).dIdx = d, o.push(c))
            }
            for (a.sort(function (e, t) {
                return e.nIdx - t.nIdx
            }), o.sort(function (e, t) {
                return e.nIdx - t.nIdx
            }), l = (l = a.concat(o)).slice(0, u), s = 0; s < l.length; s++) i.push(n.createKeyworldsHTML(l[s], n.query, e));
            var m = e ? this.elm_search_result : this.elm_result;
            m.innerHTML = "";
            for (var p, s = 0; s < i.length; s++) (p = document.createElement("LI")).innerHTML = i[s], m.appendChild(p);
            0 === i.length && ((p = document.createElement("LI")).innerHTML = (this.query, "请尝试输入一些字符，进行搜索！</span>"), m.appendChild(p))
        }, selectedResult: function (e) {
            for (var t = this.elm_result.children, n = 0, s = 0; s < t.length; s++) if ("ok" == t[s].className) {
            ...
            var n = this, e = n.getQueryString("kw");
            this.elm_query.value = e, this.query = e || "", this.elm_search_result && n.searchResult(!0), this.bindEvent(this.elm_query, "input", function (e) {
                ...
                n.elm_result.style.display = "none", n.elm_search_result ? n.searchResult(!0) : window.location.href = n.root_path + "/list.html#!kw=" + n.query
